...
def main():
    parser = argparse.ArgumentParser(description='Train DistilBERT Model for Yelp Review Sentiment Analysis')
    
    parser.add_argument('--config', type=str, required=True,
                        help='Path to YAML configuration file')
    parser.add_argument('--force_tuning', action='store_true',
                        help='Force hyperparameter tuning even if best_params exist in config')
